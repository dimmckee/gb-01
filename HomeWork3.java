...
public class HomeWork3 {
    ...
    private static void guessNumber() {
        ...
        do {
            ...
            for (int i = 3; i > 0; i--) {
                System.out.println("Введите свой ответ нажмите Enter)");
                int questionNum = scanner.nextInt();
                if (questionNum == numComp) {
                    System.out.println("Вы угадали число, молодец!");
                    break;
                }
               else if (questionNum > numComp) {
                    System.out.println("Введенное чилсо больше, введите меньшее число ");
                }
                else if ( numComp > questionNum) {
                    System.out.println("Введенное число меньше, введите большее число ");
                }
